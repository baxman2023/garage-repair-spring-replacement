...
export default function TermsPage() {
  return (
    <main>
      <p>
        <Link href="/" className="backlink">← App</Link> · <Link href="/legal/privacy">Privacy policy</Link>
      </p>
      ...
      <h2>2. Your API key, your costs, our duty</h2>
      <p>{BYO_KEY_TERMS}</p>
      <p>
      ...
      <h2>3. Commercial rights to generated copy</h2>
      <p>
      ...
      <h2>4. The compliance gate is not your lawyer</h2>
      ...
      <h2>6. Refunds and revocation</h2>
      <p>
